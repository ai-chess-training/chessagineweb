...
Make your analysis accessible for players of different skill levels and integrate both the engine evaluation and opening theory context.`;
        ...
        setLlmAnalysisResult(
          "Error running Stockfish analysis. Please try again."
        );
        setLlmLoading(false);
        return;
      }
    ...
    if (openingLoading) {
      return (
        ...
        >
          ...
          <Typography sx={{ ml: 2, color: "wheat" }}>
    ...
    if (!openingData) {
      return (
        <Typography sx={{ color: "wheat", py: 2 }}>
          Click Opening Explorer to load master game statistics for this
          position.
        </Typography>
      );
    }
                  ...
                  >
                    ...
                    >
                      <Box>
                        ...
                        <Typography variant="caption" sx={{ color: "wheat" }}>
                          {moveTotal.toLocaleString()} games ({playedPercentage}
            ...
            <TabPanel value={analysisTab} index={0}>
              ...
              {llmLoading ? (
                ...
                <Typography sx={{ color: "wheat" }}>
                  Click AI Analysis to get comprehensive analysis powered by
                  Stockfish engine data and opening theory, or click Stockfish
                  Only for raw engine evaluation. You can also click individual
                  engine lines or opening moves for specific analysis.
                </Typography>
              )}
            </TabPanel>
                        ...
                        {sessionMode && (
                          <>
                            ...
                            <Typography
                              ...
                              sx={{ fontStyle: "italic" }}
                            >
                              Your messages will include current position
                              analysis
                            </Typography>
                          </>
                        )}
